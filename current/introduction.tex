...
We add several new results showing that certain block pushing puzzles, which include the ability to push and pull blocks, are NP-hard or PSPACE-complete.
...
Elements related to push-pull block puzzles show up in a number of video games. Pukoban directly implements this type of puzzle. Other games also include block puzzles with the ability to pull blocks. The Zelda series introduces push-pull block puzzles in A Link to the Past, and this mechanic recurs in most subsequent games. Other games which include the ability to push and pull blocks are Starfox Adventures, Catherine, and the original Tomb Raider. Even more general manipulation shows up in Half-Life 1 and 2, and Portal.  In addition to representing a natural abstraction of real video games,
