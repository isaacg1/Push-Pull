...
In this section we show NP-hardness for Push-$q$ Pull-$r$ in 2D with thin walls for all positive integers $q$, $r$ in Section~\ref{2DNPhard} and Push-$k$ Pull-$l$ in 3D for all positive integers $k, l$ in Section~\ref{3DNPhard}. 
...
In this section we build up the needed two use crossover gadget from a series of weaker types of crossover gadgets.
